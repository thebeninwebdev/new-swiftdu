...
const orderSchema = new Schema<IOrder>(
  {
    ...
    cafeAvailableItems: { type: [{ _id: false, id: String, name: String, price: Number, unit: { type: String, maxlength: 30 } }], default: [] },
    cafeSelectedItems: { type: [{ _id: false, itemId: String, name: String, price: Number, quantity: Number, unit: { type: String, maxlength: 30 } }], default: [] },
