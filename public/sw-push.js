const SWIFTDU_NOTIFICATION_ICON = '/pwa-512x512.png?v=swiftdu-symbol-v1'
const SWIFTDU_NOTIFICATION_BADGE = '/pwa-192x192.png?v=swiftdu-symbol-v1'
const SWIFTDU_NOTIFICATION_IMAGE = '/logo.png?v=swiftdu-symbol-v1'
