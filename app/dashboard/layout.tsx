  ...
  return (
    ...
    >
        <div className="min-h-dvh overflow-x-hidden lg:flex">
          <DashboardMenu />
          <main className="dashboard-content min-w-0 flex-1 bg-linear-to-br from-[#f7f9fc] via-white to-[#eef7ff] pt-20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 lg:bg-transparent lg:pt-0">
            {children}
          </main>
        </div>
    </Suspense>
